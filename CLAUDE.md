...
- Client (`WorkoutPreview.tsx` L68-189) : pattern sizes 1-8, gère patterns partiels
- Serveur (`api/garmin/[action].js` L120-225) : pattern sizes 1-8, pas de patterns partiels
...
1. **Créer `src/lib/repeatDetection.ts`**
   ...
   - Utiliser la version client (la plus complète : sizes 1-8, patterns partiels)
